...
- ⏳ **Phase 9** — notification adapters (email via lettre, Slack/Discord via webhook POST, generic webhook) + handlebars templating of message/subject + retry-with-backoff dispatcher.
